...
var quickActions = [
    ...
    var intents = [

        {
            ...
            answer: {
                ...
                text:
                    'GrowthForge helps brands win modern search with AI SEO + GEO: entity clarity, technical SEO, citation-ready content, and authority systems that improve visibility in both Google and AI assistants.',

                links: [
                    {
                        href: '/ai-seo-for-b2b-saas',
                        label: 'See AI SEO details'
                    }
                ]
    ...
    function boot() {
        ...
        root.innerHTML = `
            ...
            <button
                type="button"
                class="gf-chatbot-launcher"
                aria-label="Open Executive Growth Advisor"
                aria-expanded="false"
                aria-controls="gf-chatbot-panel"
            >
            ...
            <section
                id="gf-chatbot-panel"
                class="gf-chatbot-panel"
                role="dialog"
                aria-label="Executive Growth Advisor"
                hidden
            >
                ...
                <header class="gf-chatbot-header">
                    ...
                    <div class="gf-chatbot-header-actions">
                        ...
                        >
                            ...
                            <span class="gf-chatbot-minimize-icon">
                                −
                            </span>
        ...
        var launcher =
            root.querySelector('.gf-chatbot-launcher');

        var launcherHint =
            root.querySelector('.gf-chatbot-launcher-hint');

        var panel =
            root.querySelector('.gf-chatbot-panel');

        var minimizeButton =
            root.querySelector('.gf-chatbot-minimize');

        var messages =
            root.querySelector('.gf-chatbot-messages');

        var quickActionsContainer =
            root.querySelector('.gf-chatbot-quick-actions');

        var form =
            root.querySelector('.gf-chatbot-form');

        var input =
            root.querySelector('#gf-chatbot-input');
